...
module Signet
  class << self
    # source://signet/0.20.0/lib/signet.rb#18
...
class Signet::OAuth2::Client
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#97
  def initialize(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#715
  def access_token; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#724
  def access_token=(new_access_token); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#342
  def access_type; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#351
  def access_type=(new_access_type); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#676
  def additional_parameters; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#685
  def additional_parameters=(new_additional_parameters); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#561
  def audience; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#571
  def audience=(new_audience); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#271
  def authorization_uri(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#307
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#883
  def clear_credentials!; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#359
  def client_id; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#368
  def client_id=(new_client_id); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#376
  def client_secret; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#385
  def client_secret=(new_client_secret); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#462
  def code; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#472
  def code=(new_code); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#330
  def coerce_uri(incoming_uri); end

  # source://googleauth//lib/googleauth/signet.rb#57
  def configure_connection(options); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#753
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#864
  def expired?; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#817
  def expires_at; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#827
  def expires_at=(new_expires_at); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#770
  def expires_in; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#785
  def expires_in=(new_expires_in); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#877
  def expires_within?(sec); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#608
  def expiry; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#618
  def expiry=(new_expiry); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#653
  def extension_parameters; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#663
  def extension_parameters=(new_extension_parameters); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1022
  def fetch_access_token(options = T.unsafe(nil)); end

  # source://googleauth//lib/googleauth/signet.rb#72
  def fetch_access_token!(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1190
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1114
  def generate_authenticated_request(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#987
  def googleauth_orig_generate_access_token_request(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#902
  def grant_type; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#916
  def grant_type=(new_grant_type); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#835
  def granted_scopes; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#845
  def granted_scopes=(new_granted_scopes); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#732
  def id_token; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#741
  def id_token=(new_id_token); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#799
  def issued_at; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#808
  def issued_at=(new_issued_at); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#542
  def issuer; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#552
  def issuer=(new_issuer); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1075
  def orig_fetch_access_token!(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#523
  def password; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#533
  def password=(new_password); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#580
  def person; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#590
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#480
  def redirect_uri; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#489
  def redirect_uri=(new_redirect_uri); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1090
  def refresh!(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#698
  def refresh_token; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#707
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#394
  def scope; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#405
  def scope=(new_scope); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#644
  def signing_algorithm; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#627
  def signing_key; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#637
  def signing_key=(new_key); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#444
  def state; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#453
  def state=(new_state); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#601
  def sub; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#601
  def sub=(_arg0); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#428
  def target_audience; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#436
  def target_audience=(new_target_audience); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#950
  def to_json(*_args); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#926
  def to_jwt(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#315
  def token_credential_uri; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#324
  def token_credential_uri=(new_token_credential_uri); end
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#185
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#241
  def update_token_signet_base(options = T.unsafe(nil)); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#504
  def username; end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#514
  def username=(new_username); end

  private

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1233
  def deep_hash_normalize(old_hash); end
  ...
  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1239
  def normalize_timestamp(time); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1225
  def recursive_hash_normalize_keys(val); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1256
  def set_relative_expires_at(issued_at, expires_in); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1220
  def uri_is_oob?(uri); end

  # source://signet/0.20.0/lib/signet/oauth_2/client.rb#1213
  def uri_is_postmessage?(uri); end
end
